import{d as i,j as e,a as b,b as u}from"./index-DWKUmOwF.js";import{f as $,g as f,h as w,i as v}from"./index-COuCoK-G.js";const y="var(--bg, #0b0b0b)",l="var(--card, #111)",o="var(--text, #e9e9e9)",r="var(--muted, #b7b7b7)",t="var(--border, #222)",x="var(--accent, #22c55e)",p="var(--radius, 16px)",h="var(--shadow, 0 8px 30px rgba(0,0,0,.25))",g="var(--maxw, 1200px)",c="10px",a="16px",n="24px",d="32px",m="48px",N=i.main`
    color: ${o};
    background: ${y};
`,k=i.section`
    display: grid;
