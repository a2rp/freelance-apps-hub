import{d as o,u as F,r as c,j as e,y as C}from"./index-T3yXBub7.js";const S="var(--bg, #0b0b0b)",R="var(--card, #111)",h="var(--text, #e9e9e9)",d="var(--muted, #b7b7b7)",s="var(--border, #222)",p="var(--accent, #22c55e)",T="var(--radius, 16px)",k="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",n={Wrapper:o.div`
