import{d as n,r as a,j as t}from"./index-C86gdwjR.js";const I="var(--card, #111)",j="var(--text, #e9e9e9)",d="var(--muted, #b7b7b7)",h="var(--border, #222)",g="var(--accent, #22c55e)",C="var(--radius, 16px)",M=n.div`
    color: ${j};
