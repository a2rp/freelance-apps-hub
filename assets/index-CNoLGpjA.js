import{d as o,r as l,j as e,y as N}from"./index-COA_3K4v.js";const S="var(--bg, #0b0b0b)",C="var(--card, #111)",u="var(--text, #e9e9e9)",s="var(--muted, #b7b7b7)",i="var(--border, #222)",c="var(--accent, #22c55e)",R="var(--radius, 16px)",k="var(--shadow, 0 8px 30px rgba(0,0,0,0.25))",n={Wrapper:o.div`
