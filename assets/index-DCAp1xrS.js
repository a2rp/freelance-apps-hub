import{f as q,d as l,r as m,j as e}from"./index-vzKPnzai.js";const N="var(--card, #111)",$="var(--text, #e9e9e9)",k="var(--muted, #b7b7b7)",v="var(--border, #222)",Y="var(--accent, #22c55e)",W="var(--danger, #ef4444)",X="var(--radius, 16px)",s={};s.PrintStyles=q`
