import{d as i,m as ae,r as p,j as e}from"./index-CZmFNdSy.js";import{j as ne,k as ie,l as oe,m as E,n as le}from"./index-BeOaZP3M.js";const m="var(--bg)",w="var(--card)",b="var(--text)",j="var(--muted)",d="var(--border)",g="var(--radius)",R="var(--shadow)",O="var(--accent)",v="var(--danger, #e5484d)",W="var(--good, #18a058)",_="var(--info, #2b6cb0)",de=ae`
